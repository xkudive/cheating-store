...
export default function Profile() {
    ...
    React.useEffect(() => {
        function calcWidth() {
            ...
            if (windowWidth <= 800) setMobile(true)
    ...
    return(
        <>
            <div className="profile_settings">
                {mobile && 
                    <div className="burger_btn" onClick={openModal}>
                        <span></span>
                        <span></span>
                        <span></span>
                    </div>
                ...
                {mobile ?
                        <Backdrop closeAnimation={closeModal} modalOpen={modalOpen}>
                            <div className={`profile_sidebar ${modalOpen ? "active" : ""}`} onClick={(e) => e.stopPropagation()}>
                                ...
                                <div className="profile_sidebar_links">
                                    ...
                                    <Link to="keys" onClick={() => closeModal()}>
                                    ...
                                    <Link to="balance" onClick={() => closeModal()}>
                                    ...
                                    <Link to="transactions" onClick={() => closeModal()}>
                                    ...
                                    <Link to="disputes" onClick={() => closeModal()}>
                                    ...
                                    <Link to="sales" onClick={() => closeModal()}>
                                    ...
                                    <Link to="coupons" onClick={() => closeModal()}>
                                    ...
                                    <Link to="statistics" onClick={() => closeModal()}>
                                    ...
                                    <Link to="team" onClick={() => closeModal()}>
                                    ...
                                    <Link to="advertisement" onClick={() => closeModal()}>
