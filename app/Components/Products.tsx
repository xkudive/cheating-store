                    ...
                    <div className="products_filters_filter_box_wrapper" style={{height: `${showToggle ? "0px" : height + 16 + "px"}`}}>
                        <div className="products_filters_filter_box" style={{opacity: `${showToggle ? "0" : "1"}`, pointerEvents: `${showToggle ? "none" : "all"}`}} ref={filtersContentRef}>
                            ...
                            <div className="filter_subscription">
                                ...
                                <div className={`filter_subscription_button ${filterSubscriptionDropdownActive ? " active" : ""}`} onClick={() => setFilterSubscriptionDropdownActive((filterSubscriptionDropdownActive) => !filterSubscriptionDropdownActive)}>
                                    {
                            ...
                            <div className="filter_subscription">
                                ...
                                <div className={`filter_subscription_button ${filterRatingDropdownActive ? " active" : ""}`} onClick={() => setFilterRatingDropdownActive((filterRatingDropdownActive) => !filterRatingDropdownActive)}>
                                    {
